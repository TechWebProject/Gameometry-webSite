...
$head = str_replace("Pagina dedicata alle informazioni di un singolo utente", "Questa pagina è dedicata alle ultime notizie riguardanti il mondo videoludico", $head);
