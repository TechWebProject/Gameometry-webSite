...
$head = str_replace("Pagina dedicata alle informazioni di un singolo utente", "Questa pagina è dedicata ai diversi eventi videoludici organizzati dagli appassionati di questo mondo");
