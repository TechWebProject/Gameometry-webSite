...
foreach ($imgz as $attributes) {
    $carousel .= "<form action=\"templateGioco.php\" method=\"POST\"><button name=\"immagine\" value=\"\"aria-label=\"\"><img src=\"\" alt=\"\" class=\"imgs\"></button></form>";
